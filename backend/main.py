...
==============================================
POST /api/upload/cleanse   → upload CSV, run cleansing, return issues
POST /api/upload/train     → upload CSV + model list, train & return results
POST /api/generate-report  → generate Gemini AI report from results
GET  /api/models           → list available models

Place in BMS2/ alongside cleansing.py and .env
...
Rules: No R² formulas. No citations. Plain English throughout. End with a ROI/business case sentence."""
...
Tone: direct, confident, collegial. Like you're telling your manager what happened. No fluff."""
...
- Write as if this is a section of a formal MSc thesis or regulatory submission document"""
    ...
    # ── Temperature tuned per report type ────────────────────────
    temp_map = {"executive": 0.4, "summary": 0.35, "scientific": 0.3}
    max_tok_map = {"executive": 1024, "summary": 512, "scientific": 8192}
