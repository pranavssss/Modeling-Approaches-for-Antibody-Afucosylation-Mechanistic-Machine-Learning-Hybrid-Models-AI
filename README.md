...
**Setup requires:** A Google Cloud project with OAuth 2.0 credentials and the redirect URI `http://localhost:8000/auth/google/callback` whitelisted. See Setup → Step 3.
...
**Setup requires:** A Gmail account with 2-Step Verification enabled and an App Password generated for this app. See Setup → Step 4.
